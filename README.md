...
| ML / AI | Machine Learning, Deep Learning, Data Analysis, Generative AI |
| Tools | PyCharm, Anaconda, RStudio, Git, GitHub, Google Colab |
...
|---|---|---|---|
| 🎓 BSc (Hons) Bioinformatics | Agriculture University Peshawar | 2023 – 2027 | CGPA: 3.5 / 4.00 |
| 📘 FSc Pre-Medical | Army Public School & College (APSACS) Peshawar | 2021 – 2023 | 82.90% |
| 📗 Matric Science | Army Public School & College (APSACS) Peshawar | 2019 – 2021 | 84.81% |

---

## 🏆 Achievements & Certifications

- 🥇 **HEC Generative AI Training Course — Top Performer** · Pak Angels (Dec 2025)
- ☁️ **AWS Educate Machine Learning Foundations** · Amazon Web Services (Aug 2025)
- 🤖 **Introducing Generative AI with AWS** · Udacity (Jul 2025)
- 📖 **Research Methodology** · Forman Christian College (Jul 2025)
- 🧬 **Python for Genomic Data Science** · Johns Hopkins University (Apr 2025)
- 🔬 **Introduction to Genomic Technologies** · Johns Hopkins University (Jan 2025)
- 🎖️ **IT Specialist: Python** · Certiport — A Pearson VUE Business (Jan 2025)
- 🏅 **Nominated — Prime Minister Youth Laptop Scheme 2025 (Phase-IV)**
- 📜 **NAVTTC Advanced Python & Applications** · UET Peshawar
